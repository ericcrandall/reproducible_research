...
![Crandall et al. 2023: Figure 4](images/Figure4_LogisticModels.jpg)
...
-   Everything is stored in the *invisible* .git folder inside the RStudio project.
...
-   You can click the check box next to various files to stage them to
    ...
    -   But one could consider being more strategic...
...
![](https://images.squarespace-cdn.com/content/v1/55830fd9e4b0ec758c892f81/1502123872645-1TDC1C42ZKSETL32TGPN/image-asset.jpeg?format=2500w)
...
## Branches and Pull Requests {.smaller}
...
```
  ...
  - Work on your code, committing as you go.
...
Add Revert Add Rebase Add "github pages" \* Open the
